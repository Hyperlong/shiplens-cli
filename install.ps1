# Shiplens CLI — Automated Installer (Windows)
...
if ($NeedDownload) {
    ...
    Write-Host "[Shiplens] Already up to date at $BinaryPath" -ForegroundColor Green
}
...
Write-Host "`nShiplens CLI $Version is ready! Run 'shiplens init' or 'shiplens --help' to get started." -ForegroundColor Green
