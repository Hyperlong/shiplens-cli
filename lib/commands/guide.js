const GUIDE_DATA = {
  ...
  project_operations: [
    ...
    },
    {
      id: 'projects_list',
      order: 2,
      title: 'List Account Projects',
      description: 'Query all analytics projects and associated App IDs registered under your account.',
      required_slots: [],
    ...
    },
    {
      ...
      description: 'Modify project name, functional description, and industry category classification.',
...
Project Operations:
  ...
  2. List Account Projects (view all registered analytics projects and App IDs)
  3. Update Project Information (modify project name, description, and industry taxonomy)
  4. Update Business Context Dictionary (re-scan frontend pages & buttons to refresh descriptions)
  5. Link Project to Account & Start Analytics (bind project to currently logged-in account)
  6. Remove SDK Files (eject tracking code and uninstall @shiplens/sdk dependency)
  7. Delete Project Context Files (clean up local generated .md & .json dictionary files)
  8. Delete Cloud Project (permanently destroy project and all historical event statistics)
