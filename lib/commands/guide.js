  ...
  project_operations: [
    {
      ...
      description: 'Register product under account, install SDK into local project, inject tracking code, and generate UI business context dictionary.',
    ...
    },
    {
      ...
      description: 'Query all integrated products and associated App IDs registered under your account.',
      required_slots: [],
    ...
    },
    {
      ...
      description: 'Modify registered product name, functional description, and industry category classification.',
    ...
    },
    {
      id: 'project_bind',
      order: 5,
      title: 'Link Local Project to Registered Product',
      description: 'Connect local project code with your registered cloud product to enable telemetry ingestion.',
      required_slots: ['project_name_or_path', 'email'],
      clarification_prompt: 'Please provide the local project directory (or product name) and your registered email address.',
...
Project Operations:
  1. Integrate Local Project with Analytics (register product under account + install SDK + generate UI context dictionary)
  2. List Registered Products (view all integrated products and App IDs under account)
  3. Update Product Profile (modify registered product name, description, and industry taxonomy)
  4. Update Local Business Context Dictionary (re-scan local frontend pages & buttons to refresh descriptions)
  5. Link Local Project to Registered Product (connect local project code to cloud product)
  ...
  8. Permanently Delete Product and Data (delete cloud product and all historical event data, does not affect local code)
