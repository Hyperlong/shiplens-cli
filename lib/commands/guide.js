  ...
  project_operations: [
    {
      id: 'projects_list',
      order: 1,
      title: 'List Products Integrated with Analytics',
      description: 'Query all products integrated with data analytics and associated App IDs registered under your account with full details.',
      required_slots: [],
...
Project Operations:
  1. List Products Integrated with Analytics (query all products integrated with data analytics under your account with full details)
